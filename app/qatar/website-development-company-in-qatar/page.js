import WebsiteDevQatarComponent from "./WebsiteDevQatarComponent";
import BigcommerceDubaiComponent from "./WebsiteDevQatarComponent";
...
const Page = () => {
  return <WebsiteDevQatarComponent />;
};
